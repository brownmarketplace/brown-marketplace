...
function UserListingItem(props) {
    var _this = this;
    var _a = useState(false), sold = _a[0], setSold = _a[1];
    ...
    return (React.createElement("div", { className: "user-listing-item" },
        React.createElement(Tooltip, { title: props.prodId },
            React.createElement(Link, { to: "/product/".concat(props.prodId), className: "add-listing-link" }, name ? (name) : ("Loading..."))),
        React.createElement(SoldButton, { productId: props.prodId, isSold: sold })));
}
export default UserListingItem;
//# sourceMappingURL=UserListingItem.js.map